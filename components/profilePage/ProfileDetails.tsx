...
const ProfileDetails: React.FunctionComponent<IProfileDetailsProps> = (props):any => {
  return (
    <div>
      <div className="w-11/12 mt-4 lg:mt-16 rounded-2xl lg:w-3/5 bg-white mx-auto p-8">
        ...
        <hr className="mt-4 bg-gray-50" />
        <div className="block text-center lg:flex lg:items-baseline lg:gap-2 my-4 text-cashfer-dark text-3xl">
          <div> Peter Adebimpe</div>
          <div className="text-sm text-cashfer-purple">@tosingh54</div>
        </div>

        <div className="text-center lg:text-left font-semibold text-cashfer-dark">
          09032290095
        </div>
        <div className="text-center lg:text-left text-cashfer-dark mb-8">
